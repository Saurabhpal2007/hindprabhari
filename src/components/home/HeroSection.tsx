...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        "relative z-10 text-center transition-all duration-1000 transform px-4",
        ...
        <h1 className="space-y-4">
          <span className="block text-3xl sm:text-4xl md:text-5xl font-bold mb-2">भारत की धड़कन</span>
          <span className="block text-base sm:text-lg md:text-xl text-muted-foreground mt-2 leading-relaxed">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button 
            ...
            className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white px-6 py-5 h-auto rounded-full w-full sm:w-auto"
          >
          ...
          <Button 
            ...
            className="border-2 border-orange-500 text-orange-500 hover:bg-orange-500/10 px-6 py-5 h-auto rounded-full w-full sm:w-auto"
          >
